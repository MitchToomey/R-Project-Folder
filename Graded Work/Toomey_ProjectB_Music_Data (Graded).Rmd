...
source(here("Student Work", "Student Functions", "Mitchell", "Project B functions.R"))
...
**You overwrote the final decision function, so I had to change the object**
**name below to get this to work.**
...
```{r echo=FALSE}
final_decision_2 <- final_decision(school_rating)

  final_decision_2 <- formattable(final_decision_2,
                                align= c("l", "c"))
...
**Functions folder in repo and sourcing: 20/20**

**Three functions or attempts at functions: 80/120**

**Notebook content, organization, and conclusions: 58/60**
